                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                ...
                                <p>
                                    ...
                                    latest version of Bootstrap 5 (beta
                                    1).
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                ...
                                <p>
                                    ...
                                    You are <strong>not permitted</strong> to
                                    re-distribute the template ZIP file in any
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                ...
                                <p>
                                    ...
                                    websites.
                                    If you wish to support TemplateMo, please make a
                                    small contribution via PayPal or
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{ asset('assets/img/category_img_01.jpg') }}"
                        class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Watches</h5>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{ asset('assets/img/category_img_02.jpg') }}"
                        class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Shoes</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{ asset('assets/img/category_img_03.jpg') }}"
                        class="rounded-circle img-fluid border"></a>
